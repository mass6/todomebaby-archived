...
<head>
    ...
    <title>TodoMeBaby - Forgot Password</title>
            ...
            <div class="content">
                ...
                <!-- Password recovery -->
                    ...
                    <div class="panel panel-body login-form">
                        ...
                        <button type="submit" class="btn bg-danger-700 btn-block">Send Password Reset Link <i class="icon-arrow-right14 position-right"></i></button>
                    </div>
                </form>
                <!-- /password recovery -->
